...
CREATE TABLE `garcon_chamado` (
  ...
  KEY `FK_localizacaoCliente` (`idLocalizacao`),
  KEY `FK_identQrcode` (`idQrCode`),
  CONSTRAINT `FK_garcon_chamado` FOREIGN KEY (`idGarcon`) REFERENCES `garcon` (`idGarcon`),
  CONSTRAINT `FK_identQrcode` FOREIGN KEY (`idQrCode`) REFERENCES `qrcode` (`idQrCode`),
  CONSTRAINT `FK_localizacaoCliente` FOREIGN KEY (`idLocalizacao`) REFERENCES `localizacao` (`idLocalizacao`)
...
INSERT INTO `garcon_chamado` VALUES (16,NULL,'2017-09-06 22:57:45',NULL,NULL,NULL,3,4,28),(17,NULL,'2017-09-06 23:00:23',NULL,NULL,NULL,2,3,28);
...
-- Dump completed on 2017-09-06 23:28:33
